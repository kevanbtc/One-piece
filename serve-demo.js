...
server.listen(PORT, '0.0.0.0', () => {
  console.log(`🌐 UPoF V2 Public Demo Server running on:`);
  console.log(`   Local:    http://localhost:${PORT}`);
  console.log(`   Network:  http://0.0.0.0:${PORT}`);
  console.log('');
  console.log('📱 Share this link for the public demo!');
  console.log('🎯 Perfect for banking meetings and investor demos');
});
